...
- [#102](https://github.com/tktcorporation/ziku/pull/102) [`6991251`](https://github.com/tktcorporation/ziku/commit/6991251767f90674677f9f033ee45fdd9da1ed48) Thanks [@tktcorporation](https://github.com/tktcorporation)! - GitHub REST API で参照を引けなかったとき、`git ls-remote` で引き直すようにした。
...
- [#100](https://github.com/tktcorporation/ziku/pull/100) [`d72b5a8`](https://github.com/tktcorporation/ziku/commit/d72b5a859e251919fd4c9266e949534b9d1d6573) Thanks [@tktcorporation](https://github.com/tktcorporation)! - `GITHUB_TOKEN` / `GH_TOKEN` に GitHub トークンの形をしていない値が入っている場合、その値を無視して未認証で続行するようにした。
  ...
  - 無視した場合は変数名を添えた警告を出す（1 コマンドの実行につき変数ごとに 1 回）。黙って未認証へ倒すと、private リポジトリでは 404 という無関係な症状に化けるため。警告は stderr へ出すので、`aggregate --json` の stdout は機械可読なまま保たれる。
...
- [#74](https://github.com/tktcorporation/ziku/pull/74) [`9001469`](https://github.com/tktcorporation/ziku/commit/90014694c658456c798943a4556f5703d63c1f19) Thanks [@tktcorporation](https://github.com/tktcorporation)! - Ctrl+C や `process.exit()` で中断された場合に `.ziku-temp` / `.ziku-temp-base` がターゲットディレクトリに残る問題を修正。
...
- [#44](https://github.com/tktcorporation/ziku/pull/44) [`ec54c24`](https://github.com/tktcorporation/ziku/commit/ec54c2428c56dd6c88192fb8fe58ff8764ac3d42) Thanks [@tktcorporation](https://github.com/tktcorporation)! - 依存関係を更新し、pnpm セキュリティ設定を強化する。
